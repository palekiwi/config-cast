          ...
          luaConfigPost = ''
            ...
            do
              local function apply()
                ...
                vim.api.nvim_set_hl(0, "@markup.raw.markdown_inline", { fg = "#a5d6ff" })
                vim.api.nvim_set_hl(0, "@markup.raw.block.markdown", { fg = "#a5d6ff" })
                ...
                vim.api.nvim_set_hl(0, "RenderMarkdownCodeInline", { fg = "#a5d6ff", bg = "#161b22" })
